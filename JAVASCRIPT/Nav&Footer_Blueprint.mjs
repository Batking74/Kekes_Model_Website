...
export let dymicClass = new Array(2);
dymicClass[0] = "StoreAnimateGroup1";
dymicClass[1] = "StoreAnimateGroup2";


// Dynamic HTML Pages
export function getHTMLDOC(animate1, animate2) {
    navbar.innerHTML = `
    <a href="${navLinks[6]}">
        <img src="${icons[0]}" alt="Palmer Studios logo.">
    </a>
    <a class="${animate1}" href="${navLinks[0]}">Home</a>
    <a class="${animate1} nav" href="${navLinks[1]}">About</a>
    <a class="${animate1} nav" href="${navLinks[2]}">FAQ</a>
    <a class="${animate2} nav" href="${navLinks[3]}">Contact</a>
    <a class="${animate2} nav" href="${navLinks[4]}">Store</a>
    <a class="${animate2} nav" href="${navLinks[5]}">
...
navStoreBlueprint[2] = dymicClass;
...
getHTMLDOC(dymicClass[0], dymicClass[1]);
